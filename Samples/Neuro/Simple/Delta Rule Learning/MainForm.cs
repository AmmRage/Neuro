    ...
    public class MainForm : Form
    {
        ...
        private void loadButton_Click(object sender, EventArgs e)
        {
            ...
            if (this.openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    while ((this.samples < 200) && ((str = reader.ReadLine()) != null))
                    {
                        ...
                        if (this.samples == 0)
                        {
                            ...
                            tempData = new double[200, this.variables];
                        }
                ...
                this.classesBox.Text = this.classesCount.ToString();
                this.oneNeuronForTwoCheck.Enabled = (this.classesCount == 2);

                // set neurons count
                this.neuronsCount = ((this.classesCount == 2) && (this.useOneNeuronForTwoClasses))
                    ? 1
                    : this.classesCount;
                this.neuronsBox.Text = this.neuronsCount.ToString();
        ...
        private void UpdateSettings()
        {
            ...
            this.iterationsBox.Text = this.iterationLimit.ToString();

            this.oneNeuronForTwoCheck.Checked = this.useOneNeuronForTwoClasses;
            this.errorLimitCheck.Checked = this.useErrorLimit;
        ...
        {
            this.useOneNeuronForTwoClasses = this.oneNeuronForTwoCheck.Checked;
            // update neurons count box
            this.neuronsCount = ((this.classesCount == 2) && (this.useOneNeuronForTwoClasses)) ? 1 : this.classesCount;
            this.neuronsBox.Text = this.neuronsCount.ToString();
        }
        ...
        private void EnableControls(bool enable)
        {
            ...
            this.oneNeuronForTwoCheck.Enabled = ((enable) && (this.classesCount == 2));
            this.errorLimitCheck.Enabled = enable;
        ...
        private void ClearSolution()
        {
            ...
            this.currentIterationBox.Text = string.Empty;
            this.currentErrorBox.Text = string.Empty;
        }
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.iterationLimit = Math.Max(0, int.Parse(this.iterationsBox.Text));
            }
            catch
            {
            ...
            this.useOneNeuronForTwoClasses = this.oneNeuronForTwoCheck.Checked;
            this.useErrorLimit = this.errorLimitCheck.Checked;
